...
const CardPengertianKesetaraanGender = () => {
  ...
  return (
    <AnimatedInObject animation={cardAnimation} className="lg:w-1/2 md:w-3/4 w-full">
      ...
      <div className="relative bg-[#540062] rounded-xl p-4 min-h-[500px]">
        ...
        <img className="absolute z-0 -bottom-1 -left-16 object-cover object-bottom w-[200px]" src="../img/lebahpengertiankesetaraangender.svg"/>
      </div>
    </AnimatedInObject>
